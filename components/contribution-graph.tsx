...
export const ContributionGraphCalendar = ({
  ...
  return (
    <div
      className={cn(
        "max-w-full min-w-0 overflow-x-auto overflow-y-hidden [-webkit-overflow-scrolling:touch]",
        className,
      )}
      {...props}
    >
      <svg
        className="block h-auto w-full max-w-full overflow-visible align-middle"
